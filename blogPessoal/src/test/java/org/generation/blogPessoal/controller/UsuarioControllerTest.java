...
class UsuarioControllerTest {
	...
	void saveNewUserInBankReturnStatus201() {
		...
		ResponseEntity<Usuario> response = test.exchange("/prototype/blog/users/save",
	...
	void findAllReturnStatus200() {
		ResponseEntity<String> response = test.withBasicAuth("cristianoeu@email.com","1234567")
				.exchange("/prototype/blog/users/all", HttpMethod.GET,null,String.class);
	}
